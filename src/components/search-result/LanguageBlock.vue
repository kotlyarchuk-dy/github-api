...
<template>
  <div class="relative h-[400px] w-80 bg-slate-100 divide-y divide-gray-200 rounded-lg shadow">
    <div class="max-h-full p-5 overflow-y-auto">
    ...
    <div v-if="isLoading" role="status" class="absolute top-2 right-5 border-none">
      <svg
        aria-hidden="true"
        class="inline w-8 h-8 text-transparent animate-spin fill-indigo-600"
        viewBox="0 0 100 101"
        fill="none"
